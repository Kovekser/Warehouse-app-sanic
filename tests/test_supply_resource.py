...
class SupplyResourceTestCase(TestCase):
    ...
    def test_put_supply_resource(self):
        ...
        self.assertEqual(response.json, {'msg': 'Supply 3ac93c38-7114-43dd-810a-a11384be3fd8 successfully updated'})
    ...
    def test_get_supply_by_id_not_exists_resource(self):
        ...
        self.assertEqual(response.json, {'msg': 'Supply with id f384a7d2-58a5-47f6-9f23-92b8d0d4dae8 does not exist'})